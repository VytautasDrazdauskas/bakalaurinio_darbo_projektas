...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://'+app_config.database.user+':'+app_config.database.password+'@'+app_config.database.host+':'+app_config.database.port+'/MainDB?charset=utf8mb4'
