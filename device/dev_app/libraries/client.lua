...
local protocol4 = require("git_packages.luamqtt.mqtt.protocol4")
local make_packet4 = protocol4.make_packet
local parse_packet4 = protocol4.parse_packet

local protocol5 = require("git_packages.luamqtt.mqtt.protocol5")
local make_packet5 = protocol5.make_packet
local parse_packet5 = protocol5.parse_packet

local ioloop = require("git_packages.luamqtt.mqtt.ioloop")
...
function client_mt:__init(args)
	if not luamqtt_VERSION then
		luamqtt_VERSION = require("git_packages.luamqtt.mqtt.init")._VERSION
	end
	...
	if a.connector == nil then
		if a.secure then
			...
			a.connector = require("git_packages.luamqtt.mqtt.luasocket")
		end
	end
